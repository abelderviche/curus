...
define('HTTP_IMAGES_MARCAS_PATH', $config['base_url'].'assets/images/marcas/');
define('HTTP_JS_PATH', $config['base_url'].'assets/js/');
define('HTTP_JS_DIST', $config['base_url'].'assets/dist/js/');
...
define('HTTP_IMAGES_UPLOADS_PATH', $config['base_url'].'assets/uploads/images/');
